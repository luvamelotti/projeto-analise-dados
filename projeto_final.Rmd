...
Além disso, a literatura identifica também fatores culturais (como, por exemplo, obediência às leis e confiança interpessoal) associados a corrupção. 
...
Os resultados para as variáveis qualidade do governo e IDH se mostram condizentes com a teoria. Por outro lado, a variável participação de mulheres nos Parlamentos nacionais, neste teste, apresentou resultados que vão de encontro a estudos mais recentes sobre o tema, os quais apontam uma relação negativa e significativa entre este indicador e os índices de corrupção. Além disso, a literatura oferece também análises no sentido inverso do aqui testado: corrupção como variável preditora.
